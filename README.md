...
- run the network on your own recording by: 1. cloning this repository on your machine 2. installing the required packages `pip install -r requirements.txt` 3. running the program on your own WAVE file `python3 evaluate.py <song_path> <audio_output_path>`
